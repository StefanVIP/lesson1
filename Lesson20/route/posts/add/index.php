                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>
                                ...
                                <?php
                                foreach ($userStorage->getAllUsers($_SESSION['user']) as $fullName) {
                                    echo '<option value="' . $fullName['id'] . '">' . $fullName['first_name'] . " " . $fullName['middle_name'] . " " . mb_substr($fullName['surname'],0,1) . "." . '</option>';
                                }
                                ?>
                            </td>
                        </tr>
