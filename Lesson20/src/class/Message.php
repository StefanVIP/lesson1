...
class Message
{
    ...
    {
        return $this->sender->getFirstName() . " " . $this->sender->getMiddleName() . " " . mb_substr($this->sender->getLastName(), 0, 1) . ".";
    }

    public function getRecipient(): string
    {
        return $this->recipient->getFirstName() . " " . $this->recipient->getMiddleName() . " " . mb_substr($this->recipient->getLastName(), 0, 1) . ".";
    }
